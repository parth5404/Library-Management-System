...
public class AdminComplaintController {
        ...
        public ResponseEntity<ApiResponse<PagedResponse<ComplaintResponse>>> getAllComplaints(
                ...
                Page<ComplaintResponse> complaints = complaintService.getAllComplaints(searchTerm, category, status,
                                startDate,
                                endDate, pageable);
                return ResponseEntity
                                .ok(ApiResponse.success("All complaints retrieved", PagedResponse.from(complaints)));
        }
        ...
        public ResponseEntity<ApiResponse<PagedResponse<ComplaintResponse>>> getEscalatedComplaints(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success("Escalated complaints retrieved", PagedResponse.from(complaints)));
        }
        ...
        public ResponseEntity<ApiResponse<ComplaintResponse>> assignComplaint(
                ...
                ComplaintResponse response = complaintService.assignComplaintToStaff(complaintId, staffId);
                return ResponseEntity.ok(ApiResponse.success("Complaint assigned to staff", response));
        }
}
