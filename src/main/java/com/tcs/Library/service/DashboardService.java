...
public class DashboardService {
        ...
        public DashboardStats getDashboardStats() {
                ...
                return DashboardStats.builder()
                                ...
                                // Fine stats
                                .totalFinesCollected(
                                                fineRepo.getTotalPaidFines() != null ? fineRepo.getTotalPaidFines()
                                                                : BigDecimal.ZERO)
                                .totalUnpaidFines(
                                                fineRepo.getTotalUnpaidFines() != null ? fineRepo.getTotalUnpaidFines()
                                                                : BigDecimal.ZERO)
                                ...
                                .resolvedComplaintsToday(complaintRepo.countResolvedToday(today.atStartOfDay(),
